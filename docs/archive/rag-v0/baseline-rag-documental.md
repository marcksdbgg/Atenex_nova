> **Historical — RAG documental v0.** Este era el baseline anterior al pivote
> hacia Repo Context MCP. Se conserva como evidencia y como insumo para una futura
> reactivación del RAG textual; no describe el contrato vigente.
